  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="dashboard_cx.html">Existing Reservation</a></li>
            <li class="active"><a href="dashboard_cx_res">New Reservation <span class="sr-only">(current)</span></a></li>
          </ul>
      ...
      <form class="form-reserve">
        ...
        <div class="view_button" href="select_car.html">
          <a href="select_car.html" class="btn btn-lg btn-primary btn-block" type="submit">Continue</a>
        </div>
      </form>
