    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-7 col-md-push-5">
          ...
          <h4 class="location">Location: 123 Richman ST NW, Alberta, Canada. <span class="postal-code">R1R 2K2</span></h4>
          <h4 class="phone">Phone: +1(403)403-4033</h4>
        </div>
        <div class="col-md-5 col-md-pull-7">
          <img class="featurette-image img-responsive center-block" src="Images/contact.jpeg" alt="Generic placeholder image">
        </div>
      </div>
	  </form>
      <!-- /END THE FEATURETTES -->
