      ...
      <form class="form-reserve">
        ...
        <div class="account">
          ...
          <div class="username">
            ...
            <input type="username" id="inputEmail" class="form-control" placeholder="E-mail" required autofocus>
     	  </div>
     	  <div class="password">
        ...
        <div class="license">
          ...
          <div class="license_number">
            ...
            <input type="license_number" id="inputLicenseNumber" class="form-control" placeholder="License Number" required autofocus>
          </div>
        </div>
        <div class="creditcard">
          ...
          <div class="creditcard_number">
            ...
            <input type="creditcard_number" id="inputCreditCardNumber" class="form-control" placeholder="Credit Card Number" required autofocus>
          </div>
        </div>
        <div class="age">
          <h4 class="form-age-heading" style="color:grey">Age</h2>
          <select class="age_dropdown">
        ...
        <div class="resident">
          ...
          <select class="resident_dropdown">
            <option value="Select">Select below~</option>
        ...
        <div class="view_button" href="dashboard_cx.html">
          <a href="dashboard_cx.html" class="btn btn-lg btn-primary btn-block">Done</a>
        </div>
      </form>
