    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="Images/cro1.jpg">
          <div class="container">
            <div class="carousel-caption">
              <h1>Membership Benefits</h1>
              <p>Limited time offer: 15% off on all luxury vehicles</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">Sign up today</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img src="Images/cro2.png">
          <div class="container">
            <div class="carousel-caption">
              <h1>REAL Time Update</h1>
              <p>No more surprise</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">Learn more</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img src="Images/cro3_2.jpg">
          <div class="container">
            <div class="carousel-caption">
              <h1>Wide Range of Variety</h1>
              <p>Pick the car you want today!</p>
